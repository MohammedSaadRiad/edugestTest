...
import { sampleWithRequiredData } from '../school-class.test-samples';
...
describe('SchoolClass Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.schoolClasses()[0]).toEqual(expect.objectContaining({ id: 21619 }));
  });

  describe('trackId', () => {
    it('should forward to schoolClassService', () => {
      const entity = { id: 21619 };
      jest.spyOn(service, 'getSchoolClassIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSchoolClassIdentifier).toHaveBeenCalledWith(entity);
