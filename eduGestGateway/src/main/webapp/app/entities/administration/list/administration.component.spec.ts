...
import { sampleWithRequiredData } from '../administration.test-samples';
...
describe('Administration Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.administrations()[0]).toEqual(expect.objectContaining({ id: 12826 }));
  });

  describe('trackId', () => {
    it('should forward to administrationService', () => {
      const entity = { id: 12826 };
