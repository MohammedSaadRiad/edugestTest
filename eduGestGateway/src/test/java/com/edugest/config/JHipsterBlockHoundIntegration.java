...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.edugest.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.edugest.security.DomainUserDetailsService", "createSpringSecurityUser");
